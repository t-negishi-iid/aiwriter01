            ...
            {basicSetting && (
              <CardFooter>
                <Button variant="outline" asChild className="ml-auto">
                  <Link href={`/stories/${storyId}/basic-setting`}>
                    基本設定を編集する
                  </Link>
                </Button>
              </CardFooter>
        ...
        <TabsContent value="plot">
          <Card>
            ...
            {plotDetail && (
              <CardFooter>
                <Button variant="outline" asChild className="ml-auto">
                  <Link href={`/stories/${storyId}/plot`}>
                    あらすじを編集する
                  </Link>
                </Button>
              </CardFooter>
                      ...
                      <div className="text-center py-8 bg-muted rounded-md">
                        ...
                        {currentEpisode && (
                          <Button
                            variant="outline"
                            className="mt-4"
                            onClick={() => router.push(`/stories/${storyId}/episodes/${currentEpisode.id}/generate`)}
                          >
                            エピソード内容を生成する
                          </Button>
                        )}

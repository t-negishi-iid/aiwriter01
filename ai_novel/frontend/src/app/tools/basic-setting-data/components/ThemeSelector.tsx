        ...
        themeData.forEach((category: CategoryWithThemes) => {
          ...
          if (category.subcategories) {
            category.subcategories.forEach((subcategory: Subcategory) => {
              ...
              initialSubcategoriesState[key] = data?.subcategory === subcategory.title;
            });
          }
        });
                        ...
                        {isSubcategoryExpanded(category.title, subcategory.title) && (
                          <div className={styles.themesGrid}>
                            {subcategory.themes.map((theme, themeIndex) => (
                              <div
                                key={themeIndex}
                                className={`${styles.optionCard} ${data?.title === theme.title ? styles.selectedOption : ''
                                  }`}

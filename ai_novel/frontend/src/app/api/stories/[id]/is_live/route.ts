 ...
 * フロントエンドの /api/stories/[id]/is_live/ にリクエストを受け付け、
...
export async function POST(
  ...
  try {
    ...
    console.log(`StoryIsLive API: Forwarding POST request to ${backendUrl}`);
    ...
    console.error('StoryIsLive API POST error:', error);
